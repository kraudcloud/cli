...
// KraudDomain defines model for Kraud.Domain.
type KraudDomain struct {
...
// KraudDomainCreate defines model for Kraud.DomainCreate.
type KraudDomainCreate struct {
	// Ingress ID, will use the default ingress if not specified
	IngressID *string `json:"IngressID,omitempty"`
	Name      string  `json:"Name"`
}

// KraudDomainList defines model for Kraud.DomainList.
type KraudDomainList struct {
	Items []KraudDomain `json:"items"`
}
...
// Bind implements render.Binder.
func (CreateDomainJSONRequestBody) Bind(*http.Request) error {
	return nil
}
...
// ListDomainsJSON200Response is a constructor method for a ListDomains response.
// A *Response is returned with the configured status code and content type from the spec.
func ListDomainsJSON200Response(body KraudDomainList) *Response {
	return &Response{
		body:        body,
		Code:        200,
		contentType: "application/json",
...
// CreateDomainJSON200Response is a constructor method for a CreateDomain response.
// A *Response is returned with the configured status code and content type from the spec.
func CreateDomainJSON200Response(body KraudDomain) *Response {
	return &Response{
		body:        body,
		Code:        200,
		contentType: "application/json",
